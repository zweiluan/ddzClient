...
namespace XLua.CSObjectWrap
{
    ...
    public class MyGameBaseSprotoPacketHandlerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MyGame.BaseSprotoPacketHandler);
        ...
        {
            return LuaAPI.luaL_error(L, "MyGame.BaseSprotoPacketHandler does not have a constructor!");
        }
        ...
        static int _m_Handle(RealStatePtr L)
        {
		    try {
                ...
                MyGame.BaseSprotoPacketHandler gen_to_be_invoked = (MyGame.BaseSprotoPacketHandler)translator.FastGetCSObj(L, 1);
