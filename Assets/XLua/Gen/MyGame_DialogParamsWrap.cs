...
namespace XLua.CSObjectWrap
{
    ...
    public class MyGameDialogParamsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MyGame.DialogParams);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new MyGame.DialogParams();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MyGame.DialogParams constructor!");
        ...
        static int _g_get_Msg(RealStatePtr L)
        {
		    try {
                ...
                MyGame.DialogParams gen_to_be_invoked = (MyGame.DialogParams)translator.FastGetCSObj(L, 1);
