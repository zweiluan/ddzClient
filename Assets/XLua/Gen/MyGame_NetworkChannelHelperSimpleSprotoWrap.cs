...
namespace XLua.CSObjectWrap
{
    ...
    public class MyGameNetworkChannelHelperSimpleSprotoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MyGame.NetworkChannelHelperSimpleSproto);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new MyGame.NetworkChannelHelperSimpleSproto();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MyGame.NetworkChannelHelperSimpleSproto constructor!");
        ...
        static int _m_Initialize(RealStatePtr L)
        {
		    try {
                ...
                MyGame.NetworkChannelHelperSimpleSproto gen_to_be_invoked = (MyGame.NetworkChannelHelperSimpleSproto)translator.FastGetCSObj(L, 1);
        ...
        static int _m_SendHeartBeat(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.SendHeartBeat(  );
		    ...
		    try {
                ...
                
                {
                    ...
                    System.IO.Stream _destination = (System.IO.Stream)translator.GetObject(L, 3, typeof(System.IO.Stream));
                        ...
                        var gen_ret = gen_to_be_invoked.Serialize( _packet, _destination );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    object _customErrorData;
                        ...
                        var gen_ret = gen_to_be_invoked.DeserializePacketHeader( _source, out _customErrorData );
		    ...
		    try {
                ...
                
                {
                    ...
                    object _customErrorData;
                        ...
                        var gen_ret = gen_to_be_invoked.DeserializePacket( _packetHeader, _source, out _customErrorData );
                        translator.Push(L, gen_ret);
                    translator.PushAny(L, _customErrorData);
