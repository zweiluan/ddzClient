...
namespace XLua.CSObjectWrap
{
    ...
    public class MyGameNetworkChannelHelperSprotoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MyGame.NetworkChannelHelperSproto);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new MyGame.NetworkChannelHelperSproto();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MyGame.NetworkChannelHelperSproto constructor!");
        ...
        static int _m_Initialize(RealStatePtr L)
        {
		    try {
                ...
                MyGame.NetworkChannelHelperSproto gen_to_be_invoked = (MyGame.NetworkChannelHelperSproto)translator.FastGetCSObj(L, 1);
