...
namespace XLua.CSObjectWrap
{
    ...
    public class MyGamePacketBaseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MyGame.PacketBase);
        ...
        {
            return LuaAPI.luaL_error(L, "MyGame.PacketBase does not have a constructor!");
        }
        ...
        static int _m_Clear(RealStatePtr L)
        {
		    try {
                ...
                MyGame.PacketBase gen_to_be_invoked = (MyGame.PacketBase)translator.FastGetCSObj(L, 1);
