...
namespace XLua.CSObjectWrap
{
    ...
    public class MyGamePacketHeaderSprotoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MyGame.PacketHeaderSproto);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new MyGame.PacketHeaderSproto();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MyGame.PacketHeaderSproto constructor!");
        ...
        static int _m_Clear(RealStatePtr L)
        {
		    try {
                ...
                MyGame.PacketHeaderSproto gen_to_be_invoked = (MyGame.PacketHeaderSproto)translator.FastGetCSObj(L, 1);
