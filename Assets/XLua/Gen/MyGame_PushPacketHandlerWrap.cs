...
namespace XLua.CSObjectWrap
{
    ...
    public class MyGamePushPacketHandlerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MyGame.PushPacketHandler);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new MyGame.PushPacketHandler();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MyGame.PushPacketHandler constructor!");
        ...
        static int _m_Handle(RealStatePtr L)
        {
		    try {
                ...
                MyGame.PushPacketHandler gen_to_be_invoked = (MyGame.PushPacketHandler)translator.FastGetCSObj(L, 1);
