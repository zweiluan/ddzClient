...
namespace XLua.CSObjectWrap
{
    ...
    public class MyGameXluaComponentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MyGame.XluaComponent);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new MyGame.XluaComponent();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MyGame.XluaComponent constructor!");
        ...
        static int _m_Init(RealStatePtr L)
        {
		    try {
                ...
                MyGame.XluaComponent gen_to_be_invoked = (MyGame.XluaComponent)translator.FastGetCSObj(L, 1);
