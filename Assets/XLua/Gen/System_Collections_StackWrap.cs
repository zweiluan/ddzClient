...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsStackWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(System.Collections.Stack);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new System.Collections.Stack();
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					var gen_ret = new System.Collections.Stack(_initialCapacity);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.ICollection>(L, 2))
				{
					...
					var gen_ret = new System.Collections.Stack(_col);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Stack constructor!");
        ...
        static int _m_Clear(RealStatePtr L)
        {
		    try {
                ...
                System.Collections.Stack gen_to_be_invoked = (System.Collections.Stack)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Synchronized_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.Collections.Stack _stack = (System.Collections.Stack)translator.GetObject(L, 1, typeof(System.Collections.Stack));
                    
                        var gen_ret = System.Collections.Stack.Synchronized( _stack );
                        translator.Push(L, gen_ret);
